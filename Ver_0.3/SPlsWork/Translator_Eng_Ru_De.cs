...
namespace UserModule_TRANSLATOR_ENG_RU_DE
{
    ...
    public override void LogosSplusInitialize()
    {
        ...
        SERIALIN = new InOutArray<StringInput>( 40, this );
        for( uint i = 0; i < 40; i++ )
        {
        ...
        SERIALOUT = new InOutArray<StringOutput>( 40, this );
        for( uint i = 0; i < 40; i++ )
        {
        ...
        CURRENTNAME = new InOutArray<StringParameter>( 40, this );
        for( uint i = 0; i < 40; i++ )
        {
        ...
        TRANSLATERU = new InOutArray<StringParameter>( 40, this );
        for( uint i = 0; i < 40; i++ )
        {
        ...
        TRANSLATEDE = new InOutArray<StringParameter>( 40, this );
        for( uint i = 0; i < 40; i++ )
        {
    ...
    const uint TRANSLATERU__Parameter__ = 50;
    const uint TRANSLATEDE__Parameter__ = 90;
